...
var frac={
    ...
    suma:function(){
        ...
        return 'el resultado de la suma es '+ numeradorSF + ' /denominador es' + denominadorS;
    },
    resta:function(){
        ...
        return 'el resultado de la resta es '+ numeradorRF + ' denominador es' + denominadorR;
    },
    multi:function(){
        numeradorM1=this.n1 * this.n2;
        numeradorM2=this.d1 * this.d2;
        return 'el resultado de la multiplicacion es '+ numeradorM1 + ' denominador es' +numeradorM2;
    },
    divi:function(){
        numeradorD1=this.n1 * this.d2;
        numeradorD2=this.n2 * this.d1;
        return 'el resultado de la division es '+ numeradorD1 + ' denominador es' +numeradorD2;
    }
}
