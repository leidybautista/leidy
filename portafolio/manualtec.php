...
<body>
    <div class="Contenedor">
        <div class="wrap">
            <div class="img">
                <img src="img/tecnico.png" class="img" alt="">
            </div>
            <div class="titulo">
                <br>
                <label for=""> Manual tecnio Paso a paso </label>
                <label for=""></label>
            </div>

            <div class="subtitulo">
                <br>
                <label for="">Este manual va dirigido al área de soporte técnico de la organización o a quien haga sus veces, ya que en él se detallan aspectos sobre la estructura del Sistema que le permitirá entender su funcionamiento global y posibilitar el mantenimiento del mismo  
                </label>
                <br>
                <br>
                ...
                <br>
                <br>
                <label for="">Objetivos general y especificos  </label>
                <br>
                <br>
                ...
                <br>
                <br>
                <label for="">Descripción de campos requeridos por pantalla  </label>
                <br>
                <br>
